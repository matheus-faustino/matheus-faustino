👋 Olá! Sou um desenvolvedor backend com **6 anos de experiência** em desenvolvimento web. Minha experiência inclui o uso das linguagens **PHP (7.4+)** e **C# (8.0+)**, além de frameworks como **Laravel**, **Symfony** e **ASP.NET Core**.
